...
const router = createBrowserRouter(
  createRoutesFromElements(
    <Route path='/' element={<App />}>
      ...
      <Route path='/products/:category' element={<CategoryProductsScreen />} /> {/* ✅ NEW ROUTE */}
      <Route path='/cart' element={<CartScreen />} />
      <Route path='/login' element={<LoginScreen />} />
      <Route path='/register' element={<RegisterScreen />} />
      <Route path="/privacy-policy" element={<PrivacyPolicyScreen />} />
      
      {/* 🔥 FIXED: Corrected `/verify-email/:token` route */}
      <Route path="/verify-email/:token" element={<VerifyEmailScreen />} />
      <Route path="/verify-email/pending/:email" element={<VerifyEmailScreen />} />
      ...
      <Route path='' element={<AdminRoute />}>
        ...
        <Route path='/admin/bulk-upload' element={<AdminBulkUploadScreen />} />  {/* ✅ NEW BULK UPLOAD PAGE */}
